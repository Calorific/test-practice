...
export const HEADER_LENGTH_ERROR_MESSAGE = 'Длина заголовка не должна превышать 32 символа';
export const HEADER_MIN_LENGTH_ERROR_MESSAGE = 'Заголовок не может быть пустым';
...
export const headerFieldOptions = {
  ...
  minLength :HEADER_MIN_LENGTH_ERROR_MESSAGE,
};
